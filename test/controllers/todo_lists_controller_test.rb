...
class TodoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todo_list" do
    assert_difference('TodoList.count') do
      post todo_lists_url, params: { todo_list: { duedate: @todo_list.duedate, name: @todo_list.name, note: @todo_list.note } }
    end
  ...
  test "should update todo_list" do
    patch todo_list_url(@todo_list), params: { todo_list: { duedate: @todo_list.duedate, name: @todo_list.name, note: @todo_list.note } }
